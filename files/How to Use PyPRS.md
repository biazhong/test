...
When using a custom procedure, users also need to upload the **alternatives infromation file** and the **simulation function file**. Besides these two files, users must upload a **procedure file** (a **`.py`** file). For detailed discussions about the file, please go to <a href="./Procedure File.md">Procedure File</a>.
